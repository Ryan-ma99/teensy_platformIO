...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "my_custom_message/msg/detail/pressure__type_support.h"
#include "my_custom_message/msg/detail/pressure__struct.h"
#include "my_custom_message/msg/detail/pressure__functions.h"

static void * my_custom_message__msg__pressure__create_ros_message(void)
{
  return my_custom_message__msg__Pressure__create();
}

static void my_custom_message__msg__pressure__destroy_ros_message(void * raw_ros_message)
{
  my_custom_message__msg__Pressure * ros_message = (my_custom_message__msg__Pressure *)raw_ros_message;
  my_custom_message__msg__Pressure__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool my_custom_message__msg__pressure__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * my_custom_message__msg__pressure__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(my_custom_message, msg, Pressure);

int8_t
_register_msg_type__msg__pressure(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&my_custom_message__msg__pressure__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__pressure",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&my_custom_message__msg__pressure__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__pressure",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&my_custom_message__msg__pressure__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__pressure",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&my_custom_message__msg__pressure__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__pressure",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(my_custom_message, msg, Pressure),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__pressure",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
PyMODINIT_FUNC
PyInit_my_custom_message_s__rosidl_typesupport_microxrcedds_c(void)
{
  ...
  err = _register_msg_type__msg__pressure(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }
